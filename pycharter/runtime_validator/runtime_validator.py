        ...
        for field_path, field_validations in validation_rules.items():
            ...
            if "." in field_path:
                ...
                if field_path in complete_schema["properties"]:
                    ...
                    complete_schema["properties"][field_path]["validations"].update(field_validations)
...
def get_model_from_contract(
    ...
    if isinstance(contract, str):
        ...
        raise TypeError(f"Contract must be dict, ContractMetadata, or file path string, got {type(contract)}")
