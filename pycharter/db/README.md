...
- `CoercionRulesModel` - Coercion rules
- `ValidationRulesModel` - Validation rules
- `MetadataModel` - Additional metadata
- `OwnershipModel` - Ownership information
- `GovernanceRulesModel` - Governance rules
